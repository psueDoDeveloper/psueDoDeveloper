- Hello, psueDontDevelopMuch occasionally spilling the (giant (robot)) (jelly)beans(talk) AKA ranting on a casual github account here (FYI a couple social accounts pointing to this one either got compromised or deleted, so ignore their content, or not (if it's entertaining), until identified differently, i.e. only trust the minds.com connection).
